...
<body bgcolor="white">
<div>
<img src="image/home header.png" width="100%" height="200px" />
</div>
<table class="table">
<tr>
<td>
<ul class="ul1">
    ...
    <div class="dropdown">
  	<li class="li1"><a href="eforum.php"><span class="span1">Discussion Forum</span></a></li>
    </div>
    <div class="dropdown">
  	<li class="li1"><a href="jobs.php"><span class="span1">Opportunities</span></a></li>
    </div>
    <div class="dropdown">
